...
void Drawbase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Drawbase::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Drawbase::resultReady)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Drawbase::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Drawbase.data,
...
// SIGNAL 0
void Drawbase::resultReady(const QString & _t1)
{
